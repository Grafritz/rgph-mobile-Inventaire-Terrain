...
/**
 * Entity mapped to table "tbl_codesde".
 */
public class CodeSDE {
    ...
    public CodeSDE(String NumeroOrdre, String CodeSDE, String DeptId, String ComId, String VqseId, Integer Milieu) {
